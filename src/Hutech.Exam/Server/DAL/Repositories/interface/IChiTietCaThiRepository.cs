...
namespace Hutech.Exam.Server.DAL.Repositories
{
    public interface IChiTietCaThiRepository
    {
        ...
        public Task<IDataReader> SelectBy_ma_ca_thi_Search_Paged(int ma_ca_thi, string keyword, int pageNumber, int pageSize);

        public Task<IDataReader> SelectBy_ma_ca_thi_Paged(int ma_ca_thi, int pageNumber, int pageSize);
