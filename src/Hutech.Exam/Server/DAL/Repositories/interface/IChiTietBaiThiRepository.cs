...
namespace Hutech.Exam.Server.DAL.Repositories
{
    public interface IChiTietBaiThiRepository
    {
        ...
        public Task<int> Update_v2(int MaChiTietCaThi, int MaCauHoi, int CauTraLoi, DateTime NgayCapNhat, bool KetQua);
        public Task<int> Save(int MaChiTietCaThi, long MaDeHV, int MaNhom, int MaCauHoi, int CauTraLoi, DateTime NgayTao, DateTime NgayCapNhat, bool KetQua, int ThuTu);
