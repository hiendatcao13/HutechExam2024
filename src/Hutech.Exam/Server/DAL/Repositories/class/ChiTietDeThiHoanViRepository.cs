...
namespace Hutech.Exam.Server.DAL.Repositories
{
    public class ChiTietDeThiHoanViRepository : IChiTietDeThiHoanViRepository
    {
        ...
        {
            DatabaseReader sql = new("tbl_ChiTietDeThiHoanVi_SelectBy_MaDeHV_MaNhom_MaChiTietCaThi_v3");
        ...
        {
            DatabaseReader sql = new("tbl_ChiTietDeThiHoanVi_SelectBy_MaDeHV");
            sql.SqlParams("@MaDeHV", SqlDbType.BigInt, maDeHV);
            return await sql.ExecuteReaderAsync();
        }
        public async Task<IDataReader> SelectBy_MaDeHV_MaNhom(long ma_de_hoan_vi, int ma_nhom)
        {
            DatabaseReader sql = new("tbl_ChiTietDeThiHoanVi_SelectBy_MaDeHV_MaNhom");
