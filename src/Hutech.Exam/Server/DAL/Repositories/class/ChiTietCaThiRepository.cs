...
namespace Hutech.Exam.Server.DAL.Repositories
{
    public class ChiTietCaThiRepository : IChiTietCaThiRepository
    {
        ...
        public async Task<bool> UpdateBatDau(int ma_chi_tiet_ca_thi, DateTime? thoi_gian_bat_dau)
        {
            ...
            return await sql.ExcuteNonQuery() != 0; // check xem có sự thay đổi không
        }
        ...
        public async Task<bool> Insert(int ma_ca_thi, long ma_sinh_vien, long ma_de_thi, int tong_so_cau)
        {
