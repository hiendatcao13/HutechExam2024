...
namespace Hutech.Exam.Shared.DTO.Request.NhomCauHoi
{
    ...
    {
        public NhomCauHoiUpdateRequest()
        {
        }

        public NhomCauHoiUpdateRequest(int maDeThi, string tenNhom, int kieuNoiDung, string noiDung, int soCauHoi, bool hoanVi, int thuTu, int maNhomCha, int soCauLay, bool laCauHoiNhom)
        {
            MaDeThi = maDeThi;
            TenNhom = tenNhom;
