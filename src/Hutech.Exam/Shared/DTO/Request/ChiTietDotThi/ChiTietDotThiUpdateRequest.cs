...
{
    public class ChiTietDotThiUpdateRequest
    {
        public ChiTietDotThiUpdateRequest()
        {
        }

        public ChiTietDotThiUpdateRequest(string tenChiTietDotThi, int maLopAo, int maDotThi, int lanThi)
        {
